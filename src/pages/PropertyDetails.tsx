...
export default function PropertyDetails() {
  ...
  const shareTwitter = (url: string, title: string) => {
  ...
  const frontendBaseUrl = import.meta.env.VITE_CLIENT_URL; // e.g. https://property-pulse-fe.vercel.app

  const propertyUrl = `${frontendBaseUrl}/property/${property._id}`;
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white shadow-sm border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  onClick={() => shareFacebook(propertyUrl)}
                  className="flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm transition-colors"
                >
                  Facebook
                </button>

                <button
                  onClick={() => shareTwitter(propertyUrl, property.title)}
                  className="flex items-center justify-center gap-2 px-4 py-2 bg-sky-500 hover:bg-sky-600 text-white text-sm transition-colors"
                >
                  Twitter
                </button>

                <button
                  onClick={() => shareWhatsApp(propertyUrl, property.title)}
                  className="flex items-center justify-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm transition-colors"
                >
                  WhatsApp
                </button>

                <button
                  onClick={() => copyLink(propertyUrl)}
                  className="flex items-center justify-center gap-2 px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white text-sm transition-colors"
                >
                  Copy Link
                </button>
              </div>
