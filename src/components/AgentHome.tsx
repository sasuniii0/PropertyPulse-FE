    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            className="flex items-center gap-3 p-4 border-2 border-teal-600 bg-teal-50 hover:bg-teal-100 transition-colors rounded-lg"
            >
            ...
            className="flex items-center gap-3 p-4 border-2 border-gray-300 hover:border-gray-400 hover:bg-gray-50 transition-colors rounded-lg"
            >
            <div className="w-12 h-12 bg-gray-600 rounded-lg flex items-center justify-center text-white flex-shrink-0">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
